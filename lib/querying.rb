...
def select_series_title_with_most_human_characters
  "SELECT Series.title WHERE MAX(characters.species) FROM ((series INNER JOIN authors ON Authors.id = Series.author_id) INNER JOIN subgenres ON Subgenres.id = Series.subgenre_id)"
end
