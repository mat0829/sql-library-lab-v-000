...
def select_series_title_with_most_human_characters
  "SELECT Series.title WHERE MAX(characters.species = 'human') FROM ((character_books INNER JOIN Series. ON Authors.id = Series.author_id) INNER JOIN subgenres ON Subgenres.id = Series.subgenre_id)"
end
