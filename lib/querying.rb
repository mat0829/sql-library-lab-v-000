...
def select_name_and_series_subgenres_of_authors
  "SELECT Authors.name, Subgenres.name FROM AUTHORS INNER JOIN AUTHORS ON Series.author_id = Authors.id INNER JOIN SERIES ON Series.subgenre_id = Subgenres.id;"
end
